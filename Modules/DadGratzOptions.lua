    ...
    general = {
      ...
      args = {
        ...
        details = {
          ...
          get = function()
            return DadGratz.db.profile.showDetails
          end,
          set = function(key, value)
            DadGratz.db.profile.showDetails = value
            if not DadGratz.db.profile.showDetails then
              DadGratz.db.profile.showAllItemsAlways = value
            end
          end,
        },
        alwaysShow = {
