...
DG_globals.jokesSafe = {
  "Well, that thar be a nice achievement you got there!",
  "Dude thats awesome!",
  "Magnifico!",
  "Great Achievement! keep up the aweshumm :D",
  "Well done that person!!",
  "I do believe that you got a nice cheevo!",
  "Glad to see the achievement! nice one!",
  "OOooooh nice achievement!! :)",
  ...
  "That guildy deserves a medal... oh wait, we call them achievements... WELL DONE!! :D",
  "You got an achievement!.. showing today on front row! [anyone who got that reference deserves a cookie!!]",
  "Thats a nice achievement, really, truly, very... well done! most impressed! :)",
  "GRATZAMONDO!! :D",
  "Perfectly executed achievement, top notch, well done!",
  "Thats plenty brilliant! nice one!",
